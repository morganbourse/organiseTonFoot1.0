...
(function($) {
    ...
    $.fn.ezBgResize = function(options) {
		...
		$("<img/>").attr("src", jqez.img).load(function() {
            ...
            var firstTime = $("#jq_ez_bg").length == 0;
            ...
            {
                //check if the same img of the previous
                if(jqez.img[0] == $("#jq_ez_bg").find('img:first').attr("src"))
                {
                    return;
                }
            
                $( "#jq_ez_bg" ).fadeOut(1500, "linear", function(){
                    treat();
                
                    $( "#jq_ez_bg" ).fadeIn( 1500, "linear", function(){} );
                });
            }
